...
{
    public class DataStore : IDataStore, IGroupDataStore, IObjectDataStore, IVertexDataStore, ITextureDataStore, INormalDataStore,
                             IFaceGroup, IMaterialLibrary, IElementGroup
    {
        ...
        {
            _currentGroup = new Group(objectName);
        ...
        public void AddVertex(Vertex vertex)
        {
            ...
            _currentGroup.Verticies.Add(vertex);
        }
        ...
        public void SetMaterial(string materialName)
        {
            ...
            PushGroupIfNeeded();
            _currentGroup.Set_Material( material );
        }
    }
}