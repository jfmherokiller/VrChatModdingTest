...
namespace ObjLoader.Loader.Loaders
{
    ...
    public class MaterialLibraryLoader : LoaderBase, IMaterialLibraryLoader
    {
        ...
        public MaterialLibraryLoader(IMaterialLibrary materialLibrary)
        {
            ...
            AddParseAction("map_Ke", m => CurrentMaterial.EmissiveTextureMap = m);
            ...
            AddParseAction("map_Tr", m => CurrentMaterial.AlphaTextureMap = m);// Yea yea I know it isnt the same thing. BITE ME!
            ...
            AddParseAction("map_disp", m => CurrentMaterial.DisplacementMap = m);
